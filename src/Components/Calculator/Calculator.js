              ...
              <div className="calculator__parameter-container">
                ...
                <div className="calculator__address">
                  ...
                  <div className="calculator__address-container">
                    ...
                    <div className="calculator__input-container">
                      <input type="tel" onChange={this.changeAddress} name="flat" placeholder="Квартира" className="calculator__input--short"/>
                      <input type="tel" onChange={this.changeAddress} name="Entrance" placeholder="Подъезд" className="calculator__input--short"/>
                    </div>
                  </div>
                </div>
              </div>
              <div className="calculator__parameter-container">
                ...
                <div className="calculator__userInfo">
                  <div className="calculator__userInfo-container">
                    ...
                    <input type="tel" onChange={this.changeUserInfo} name="phoneNumber" placeholder="Телефон" className="calculator__input--long"/>
                  </div>
                  <div className="calculator__userInfo-container">
                    <input type="email" onChange={this.changeUserInfo} name="e-mail" placeholder="e-mail" className="calculator__input--long"/>
